...
void Greenhouse__shift_step(int time, Greenhouse__shift_out* _out,
  ...
  if (ck_1_1) {
    ...
    if (ck_1_2_1) {
      ...
      v_84 = nr_St_Afternoon;
      ns_St_Afternoon_1 = true;
      v_80 = ns_St_Afternoon_1;
      ns_St_Afternoon_2 = true;
      v_81 = ns_St_Afternoon_2;
    ...
    if (ck_1_2_0) {
      ...
      v_79 = n_St_Morning;
      v_85 = nr_St_Morning;
      v_82 = ns_St_Morning_1;
      v_83 = ns_St_Morning_2;
    } else {
      d_St_Night = false;
      v_73 = d_St_Night;
      m_St_Night = false;
